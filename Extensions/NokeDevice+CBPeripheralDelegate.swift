...
extension NokeDevice: CBPeripheralDelegate {
    ...
    public func peripheral(_ peripheral: CBPeripheral, didDiscoverServices error: Error?) {
        ...
        for s: CBService in (peripheral.services!){
            if(s.uuid.isEqual(NokeDevice.nokeServiceUUID())){
                ...
                self.nokeService = s
                self.peripheral?.discoverCharacteristics([NokeDevice.aclCharacteristicUUID(),
    ...
    public func peripheral(_ peripheral: CBPeripheral, didWriteValueFor characteristic: CBCharacteristic, error: (any Error)?) {
        ...
        guard let error = error else {
            ...
            if characteristic.uuid == aclCharacteristic?.uuid {
                ...
                print("Command signature written \(string)")
            }
            return
        }
