...
**Ion 2 locks use advanced cryptographic signing instead of traditional encryption.**

For Ion 2 integration, we provide a **zero-configuration** solution that works out of the box:

📘 **[Ion 2 Integration Guide](ION2_INTEGRATION_GUIDE.md)** - Complete guide for Ion 2 locks with zero-config setup

**Quick Start for Ion 2:**
```swift
...
PhoneKeyFacade.shared.ensureProvisioned(
    ...
    case .success(let acls):
        print("Ready to unlock \(acls.count) Ion 2 locks")
...
- ✅ Automatic key generation and storage (keychain)
- ✅ ACL caching for offline access
- ✅ Thread-safe
- ✅ iOS 12+ compatible
- ✅ Customizable via protocols (optional)

**See the [Integration Guide](ION2_INTEGRATION_GUIDE.md) for complete documentation.**

---

## Legacy Locks (NokeOne, ION, Padlock, etc.)

For legacy locks using traditional encryption, continue reading below:
